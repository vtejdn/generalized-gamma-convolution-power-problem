...
> **Historical checkpoint — 2026-09-06.** All seven route programs and their pre-cleanup disposition.
> Preserved from `CurrentGoal.md` at commit `527a78a`, annotated tag
> `snapshot-2026-09-06-pre-cleanup`. The original body is retained below;
> only relative Markdown link targets have been rebased for this location.
> Contemporary status or next-action wording in that body is historical.
> Current record: [CurrentGoal.md](../../CurrentGoal.md).
