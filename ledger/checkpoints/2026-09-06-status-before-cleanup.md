<!-- Historical checkpoint; do not use as current execution or status authority. -->

> **Historical checkpoint — 2026-09-06.** The complete pre-cleanup status, route history and preliminary result list.
> Preserved from `ResearchStatus.md` at commit `527a78a`, annotated tag
> `snapshot-2026-09-06-pre-cleanup`. Relative Markdown links were rebased.
> On 2026-09-06, at the user's request, the three obsolete SD-only source
> links were removed when the local SD directory was deleted. The remaining
> mathematical and historical body is unchanged; the complete original
> source list remains available at the named commit/tag.
> Contemporary status or next-action wording in that body is historical.
> Current record: [ResearchStatus.md](../../ResearchStatus.md).
